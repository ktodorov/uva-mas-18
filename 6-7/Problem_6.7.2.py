...
"Importance Sampling"
# Setting up a list to save the result of each importance sampling calculation
IS_runs = 3000 # number of runs (N)
run_counter = 0
IS_results = []
...
# Analyzing N IS samples for the average and standard deviation
